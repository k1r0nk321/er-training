        ...
        <div className="max-w-md mx-auto px-4 py-8 space-y-5">
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="text-xs text-emerald-600 mt-0.5">最新の機能改善・追加情報{appUpdates.length > 0 && ` · ${new Date(appUpdates[0].created_at).toLocaleDateString('ja-JP', {month: 'numeric', day: 'numeric'})}更新`}</div>
            </div>
