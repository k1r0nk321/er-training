...
// ===== STYLES =====
const S = `
@import url('https://fonts.googleapis.com/css2?family=Noto+Sans+JP:wght@400;500;600;700&family=JetBrains+Mono:wght@400;600&display=swap');
*{box-sizing:border-box;margin:0;padding:0}
:root{
  --bg:#0a0e1a;--s1:#111827;--s2:#1a2236;--bd:#1e2d45;
  --ac:#00d4ff;--ac2:#ff6b35;--ok:#00e676;--warn:#ffab40;--err:#ff5252;
  --tx:#e8edf5;--mu:#6b7fa3;--c1:#00d4ff;--c2:#a78bfa;--c3:#34d399;
}
